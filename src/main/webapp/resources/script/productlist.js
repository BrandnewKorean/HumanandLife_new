			...
			for(var i=0;i<list.length;i++){
				...
				if(eventlist[i] != null){
					if(eventlist[i]['ispersent']){
						...
						textString = '<a href="product?product_code='+list[i]['product_code']+'" class="name">'+list[i]['name']+'</a><br><a class="price">'+df.format(list[i]['event_price'])+'원</a><br><a class="original-price">'+df.format(list[i]['price'])+'원</a>';
						...
						textString = '<a href="product?product_code='+list[i]['product_code']+'" class="name">'+list[i]['name']+'</a><br><a class="price">'+df.format(list[i]['price'])+'원</a>';
					}
				}else{
					textString = '<a href="product?product_code='+list[i]['product_code']+'" class="name">'+list[i]['name']+'</a><br><a class="price">'+df.format(list[i]['price'])+'원</a>';
				}
